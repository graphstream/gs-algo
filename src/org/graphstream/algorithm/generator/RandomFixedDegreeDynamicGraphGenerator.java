...
import org.graphstream.io.DynamicGraphWriterHelper;
...
// Attributes
	...
	public void generate( Graph graph )
	{
		...
		// pour l'ensemble des �tapes, on cr�� des sommets et des liens
		for( int s = 1; s < nbSteps; s++ )
		{
			...
			for( int r = 1; r <= nbSuppressions; r++ )
			{
				...
				// avant de flinguer le noeud, il faut lister ses ar�tes de fa�on
				// � r�cup�rer leur �ge.
			...
			// la vitesse de cr�ation des sommets initiaux d�pend de la pente ici 10000
			...
			// la limite maximale du degr� moyen est donn�e par l'utilisateur, c'est
			// un parametre.
...
//		int[] distrib = dynagraph.getDegreeDistribution();
	...
	public static String usage = "\nRandomFixedDegreeDynamicGraphGenerator \n"
	        ...
	        + "\t\t-meanDegreeLimit=<degr� moyen max (r�el)>\n"
	        + "\t\t-nervousness=<nervosit� (r�el)>\n" + "\t\t-nbSteps=<nombre d'�tapes (entier)>\n";
}