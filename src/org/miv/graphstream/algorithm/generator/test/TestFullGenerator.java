...
public class TestFullGenerator
{
	...
	{
		if( args.length > 0 )
		     new TestFullGenerator( args );
		else new TestFullGenerator( null );
	}
	
	public TestFullGenerator( String args[] )
	{
		int    size     = 10;
		...
		FullGenerator fg = new FullGenerator( true, true );
		
		fg.addNodeLabels( true );
		fg.begin( g );
