 ...
 * 
 * <p>
 * This class is automatically instanced by the various implementations of
 * the Graph interface. Furthermore, the various {@link org.miv.graphstream.graph.Graph}
 * implementations are free to refine several algorithms to optimise them for their internal
 * representation.
 * </p>
 * 
...
/*
		...
		return modularity( E );
*/
		return modularity( modularityMatrix( communities( marker ) ) );
	}
	 ...
	 */
	public float[] getNodePosition( String id )
	{
	...
	/**
	 * Like {@link #getNodePosition(String)} but use an existing node as argument.
	...
	/**
	 * Like {@link #getNodePosition(String)}, but instead of returning a newly allocated array,
	 ...
	 */
	public void getNodePosition( String id, float xyz[] )
	...
	/**
	 * Like {@link #getNodePosition(String,float[])} but use an existing node as argument.
	 * @param node The node to consider.
	 * @param xyz An array of at least three cells.
	 */
	public void getNodePosition( Node node, float xyz[] )
	{
		if( xyz.length < 3 )
			return;
	 ...
	 */
	public float getEdgeLength( String id )
		throws NotFoundException
	{
	...
	/**
	 * Like {@link #getEdgeLength(String)} but use an existing edge as argument.
	 * @param edge
	 * @return The edge length or -1 if the nodes of the edge have no positions.
	 */
