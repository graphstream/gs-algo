...
//		org.miv.util.ui.MemoryMonitor.show();
		...
		while( edges.hasNext() )
		{
			...
			if( ! edge.hasAttribute( weightAttr ) )
				edge.addAttribute( weightAttr, 1f );
		}
		...
		dijkstra = new Dijkstra(graph,Dijkstra.Element.edge, weightAttr,source);
