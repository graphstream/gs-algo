 ...
 * @since 2007
 */
public class LayoutListenerHelper implements LayoutListener, MBoxListener
{
// Attributes
...
// Constructors
	 ...
	 */
	public LayoutListenerHelper( LayoutListener listener )
	{
	 ...
	 */
	public LayoutListenerHelper( Graph graph )
	{
		this.events = new MBoxStandalone( this );
		this.graph  = graph;
	}
...
// Commands
	...
	public void processMessage( String from, Object[] data )
	{
		...
		{
			float percent = (Float) data[1];
			
			for( LayoutListener listener: listeners )
				listener.stepCompletion( percent );			
		}
	}
}